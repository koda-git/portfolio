            ...
            <div className="grid grid-cols-1 lg:grid-cols-12">
                <div className="col-span-7 place-self-center text-center sm:text-left">
                    <h1 className="text-white mb-4 text-4xl sm:text-5xl lg:text-6xl font-extrabold">
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-blue-600">Hello I'm{" "}</span><br></br>
                        <TypeAnimation
                            sequence={[
                    ...
                    With a love for all things tech, I’m constantly exploring new tools, languages, and systems. 
...
className="px-1 py-1 w-full  sm:w-fit rounded-full bg-gradient-to-br from-blue-500 via-blue-600 to-blue-50 hover:bg-blue-800 text-white"> <span className="block bg-[#121212] hover:bg-blue-800 rounded-full px-5 py-2">My Projects</span></button>
